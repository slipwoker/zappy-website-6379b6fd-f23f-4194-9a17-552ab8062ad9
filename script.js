document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if ((type === 'tel' || name.toLowerCase().includes('phone')) && !validatePhone(value)) {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .slide-up, .slide-in, [data-animate], .animate-on-scroll, .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .portfolio-item, .blog-card, .stat-item, .step-item'
  );
      ...
      const observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const delay = el.getAttribute('data-delay') || el.dataset.animateDelay || 0;
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          Array.from(children).forEach(function (child, index) {
            setTimeout(function () {
              child.classList.add(animationClass, visibleClass);
            }, index * staggerDelay);
          });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "MOVIE FOX uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6379b6fd-f23f-4194-9a17-552ab8062ad9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6379b6fd-f23f-4194-9a17-552ab8062ad9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6379b6fd-f23f-4194-9a17-552ab8062ad9';
